...
/* uncomment if using ResourceBundle */
public class amqbdlh {
  ...
  public amqbdlh() {
    ...
    if (myMsgDataLth == null) {
      myQueue = System.getProperty("ml");
    }
  ...
  private void prtMessage(MQMessage myMessage) {
    ...
    try {
      ...
      System.out.println(
          "  Report   : " + myMessage.report + "  MsgType : " + myMessage.messageType);
      System.out.println("  Expiry   : " + myMessage.expiry + "  Feedback : " + myMessage.feedback);
      System.out.println(
          "  Encoding : " + myMessage.encoding + "  CodedCharSetId : " + myMessage.characterSet);
      System.out.println("  Format : '" + myMessage.format + "'");
      System.out.println(
          "  Priority : " + myMessage.priority + "  Persistence : " + myMessage.persistence);
    ...
    try {
      ...
      while (myrc != MQException.MQRC_NO_MSG_AVAILABLE) {
        ...
        try {
          ...
          if (getex.reasonCode == MQException.MQRC_NO_MSG_AVAILABLE) {
            ...
            if (getex.reasonCode != MQException.MQRC_TRUNCATED_MSG_ACCEPTED) {
              System.out.println(
                  "MQ error: Completion code "
                      + getex.completionCode
                      + " Reason code "
                      + getex.reasonCode);
            }
          }
        ...
        try {
          ...
          System.out.println(
              myReason + "," + myQName.trim() + "," + myQmgr.trim() + "," + myAppName.trim());
      ...
      try {
        ...
        System.out.println(
            "MQ error: Completion code " + ex.completionCode + " Reason code " + ex.reasonCode);
      }
